...
const GLOBAL_LEADERBOARD_DATA: LeaderboardEntry[] = [
  { rank: 1, playerName: 'Capt. Hector Silva', role: 'Master Mariner', vesselName: 'M/V Santos Star', countryCode: 'üáµüáπ', totalWinningsOD: 142500.0, totalJackpotWins: 3, favoriteGame: '$3.85M Mega Jackpot', winStreak: 7, verified: true },
  { rank: 2, playerName: 'Elena Rostova', role: 'Cruise Guest VIP', vesselName: 'S/S Symphony Seas', countryCode: 'üá≤üá®', totalWinningsOD: 98400.0, totalJackpotWins: 2, favoriteGame: 'Treasure Reef Roulette', winStreak: 12, verified: true },
  { rank: 3, playerName: 'Chief Eng. Lars Lindqvist', role: 'Chief Engineer', vesselName: 'Arctic Pioneer Tanker', countryCode: 'üá∏üá™', totalWinningsOD: 76200.0, totalJackpotWins: 2, favoriteGame: "America's Cup Regatta", winStreak: 5, verified: true },
  { rank: 4, playerName: 'Mateo Rossi', role: 'Marine Tech Specialist', vesselName: 'Port of Genoa Hub', countryCode: 'üáÆüáπ', totalWinningsOD: 54100.0, totalJackpotWins: 1, favoriteGame: 'Neptune Scratchers', winStreak: 4, verified: true },
  { rank: 5, playerName: 'Chief Off. William Chen', role: 'First Officer', vesselName: 'Orient Express Cargo', countryCode: 'üá∏üá¨', totalWinningsOD: 42900.0, totalJackpotWins: 1, favoriteGame: 'Seafarer Daily Raffle', winStreak: 8, verified: true },
  { rank: 6, playerName: 'Sophie Laurent', role: 'Cruise Entertainment Crew', vesselName: 'M/S Mediterranean Gem', countryCode: 'üá´üá∑', totalWinningsOD: 38700.0, totalJackpotWins: 1, favoriteGame: 'Treasure Reef Roulette', winStreak: 3, verified: true },
  { rank: 7, playerName: '2nd Eng. Kwame Mensah', role: 'Second Engineer', vesselName: 'Atlantic Bulk Carrier', countryCode: 'üá¨üá≠', totalWinningsOD: 29400.0, totalJackpotWins: 1, favoriteGame: 'Tug-of-War League', winStreak: 6, verified: true },
  { rank: 8, playerName: "Capt. James O'Connor", role: 'Tugboat Captain', vesselName: 'M/T Pacific Titan', countryCode: 'üá¶üá∫', totalWinningsOD: 24800.0, totalJackpotWins: 0, favoriteGame: 'Drone Speed Sprint', winStreak: 5, verified: true },
  { rank: 9, playerName: 'Isabella Santos', role: 'Marine Hydrographer', vesselName: 'High Seas Surveyor IV', countryCode: 'üáßüá∑', totalWinningsOD: 18900.0, totalJackpotWins: 0, favoriteGame: 'Neptune Scratchers', winStreak: 3, verified: true },
  { rank: 10, playerName: 'Dmitri Volkov', role: 'Deck Cadet', vesselName: 'Barents Sea Container', countryCode: 'üá™üá™', totalWinningsOD: 15400.0, totalJackpotWins: 0, favoriteGame: 'Seafarer Daily Raffle', winStreak: 4, verified: true }
];

import { OceanGamingLiveWatchPortalView } from './OceanGamingLiveWatchPortalView';
import { LotteryWinnerAnalyticsView } from './lottery/LotteryWinnerAnalyticsView';
import { LotteryNotificationSettingsView } from './lottery/LotteryNotificationSettingsView';
import { LiveDrawTimerComponent } from './lottery/LiveDrawTimerComponent';
import { LotteryProfitCalculatorView } from './lottery/LotteryProfitCalculatorView';
import { DrawWinnerVerificationView } from './lottery/DrawWinnerVerificationView';
import { AnimatedLiveDrawComponent } from './lottery/AnimatedLiveDrawComponent';
import { LotteryPayoutView } from './lottery/LotteryPayoutView';
import { DrawSecurityLogView } from './lottery/DrawSecurityLogView';
import { WinnerSpotlightView } from './lottery/WinnerSpotlightView';
import { LotteryPredictiveWinEngineView } from './lottery/LotteryPredictiveWinEngineView';
import { LotteryHistoryChartView } from './lottery/LotteryHistoryChartView';
import { WinningAlertSetupModal } from './lottery/WinningAlertSetupModal';
...
export const OceanGamingLotteryPortalView: React.FC = () => {
  ...
  // Active Sub Tab
  const [winningAlertModalOpen, setWinningAlertModalOpen] = useState<boolean>(false);
  const [activeTab, setActiveTab] = useState<
    ...
    | 'jackpot-live-feed'
    | 'lottery-analytics'
    | 'lottery-notifications' | 'predictive-win-engine' | 'lottery-history-chart'
    | 'responsible-play'
    | 'social-gaming-lobby'
    | 'lottery-winnings-bank' | 'lottery-profit-calculator' | 'winner-verification' | 'animate-live-draw' | 'lottery-payout' | 'draw-security-log' | 'winner-spotlight'
  >('lottery-hub');
  ...
  const [liveFeedItems, setLiveFeedItems] = useState<Array<{
    ...
    { id: 'feed-1', player: 'Capt. Hector Silva', vessel: 'M/V Santos Star', flag: 'üáµüáπ', event: 'HIT 500x MULTIPLIER ON NEPTUNE SCRATCHER!', amountOD: 2500, gameType: 'SCRATCHERS', timeAgo: '12s ago', likes: 14 },
    { id: 'feed-2', player: 'Elena Rostova', vessel: 'S/S Symphony Seas', flag: 'üá≤üá®', event: 'WON TREASURE REEF ROULETTE SINGLE NUMBER #18', amountOD: 1800, gameType: 'ROULETTE', timeAgo: '45s ago', likes: 22 },
    { id: 'feed-3', player: 'Chief Eng. Lars L.', vessel: 'Arctic Pioneer', flag: 'üá∏üá™', event: 'PURCHASED 10x $3.85M MEGA JACKPOT TICKETS', amountOD: 50, gameType: 'MEGA_JACKPOT', timeAgo: '1m ago', likes: 8 },
    { id: 'feed-4', player: 'Mateo Rossi', vessel: 'Port of Genoa Hub', flag: 'üáÆüáπ', event: 'WON AMERICA‚ÄôS CUP REGATTA HYDROFOIL BET', amountOD: 925, gameType: 'REGATTA', timeAgo: '3m ago', likes: 19 },
    { id: 'feed-5', player: 'Chief Off. William Chen', vessel: 'Orient Express', flag: 'üá∏üá¨', event: 'CLAIMED DAILY SEAFARER RAFFLE PRIZE', amountOD: 450, gameType: 'RAFFLE', timeAgo: '5m ago', likes: 31 }
  ]);
  ...
  const [chatMessages, setChatMessages] = useState<Array<{
    ...
    { id: 'msg-1', sender: 'Capt. Hector Silva', role: 'Master Mariner', vessel: 'M/V Santos Star', flag: 'üáµüáπ', text: 'Good luck on tonight‚Äôs $3.85M Mega Jackpot draw, crew! Just locked in my 6 numbers.', timestamp: '14:22 UTC' },
    { id: 'msg-2', sender: 'Elena Rostova', role: 'Cruise VIP', vessel: 'S/S Symphony Seas', flag: 'üá≤üá®', text: 'The Treasure Reef Roulette wheel is hot today! Just hit red #18!', timestamp: '14:25 UTC', ticketHash: '0x11e9201a8829' },
    { id: 'msg-3', sender: '2nd Eng. Kwame Mensah', role: 'Second Engineer', vessel: 'Atlantic Bulk Carrier', flag: 'üá¨üá≠', text: 'Who wants to join our Sailor Syndicate Co-Op pool for tonight‚Äôs draw? We have 85 entries pooled!', timestamp: '14:28 UTC' }
  ]);
  ...
  const [jurisdictionInfo, setJurisdictionInfo] = useState<{
    ...
    permittedCountriesList: ['United Kingdom', 'Malta', 'Singapore', 'Isle of Man', 'Gibraltar', 'Cura√ßao', 'Australia', 'Canada', 'Marshall Islands', 'Portugal', 'Sweden', 'Italy', 'France', 'Germany', 'Ghana', 'Estonia', 'Brazil', 'Japan'],
  ...
  const handleCountryJurisdictionCheck = async (selectedCountry: string) => {
    ...
    try {
      ...
      const PERMITTED = ['United Kingdom', 'Malta', 'Singapore', 'Isle of Man', 'Gibraltar', 'Cura√ßao', 'Australia', 'Canada', 'Marshall Islands', 'Portugal', 'Sweden', 'Italy', 'France', 'Germany', 'Ghana', 'Estonia', 'Brazil', 'Japan'];
  ...
  const [stakingNotifList, setStakingNotifList] = useState<Array<{
    ...
    {
      id: 'STK-NT-101',
      title: '‚ö° Daily Yield Dividend Accrued',
    ...
    {
      id: 'STK-NT-102',
      title: 'üîÑ Automated Compound Reinvested',
    ...
    {
      id: 'STK-NT-103',
      title: 'üëë Sovereign Admiral Tier Boost',
    ...
    {
      id: 'STK-NT-104',
      title: 'üîì Staking Maturity Alert',
  ...
  const [stakeActivityLogs, setStakeActivityLogs] = useState<Array<{
  ...
  }>>([
    {
      ...
      amount: 15000,
      currency: 'OD',
      poolName: 'üëë 365-Day VIP Fleet Vault',
    ...
    },
    {
      ...
      amount: 142.50,
      currency: 'OD',
      poolName: 'üíé 90-Day Blue Carbon Vault',
    ...
    },
    {
      ...
      amount: 68.20,
      currency: 'OD',
      poolName: '‚öì 30-Day Sovereign Reserve',
  ...
  const [whaleWallets] = useState<Array<{
    ...
    {
      id: 'WHL-001',
      alias: 'üêã Sovereign Admiral Leviathan',
      address: '0x94A...8811',
      totalStaked: 1450000,
      primaryPool: 'üëë 365-Day VIP Fleet Vault',
      tier: 'Fleet Admiral',
    ...
    {
      id: 'WHL-002',
      alias: '‚ö° Poseidon Maritime Capital',
      address: '0x32C...1092',
      totalStaked: 980000,
      primaryPool: 'üíé 90-Day Blue Carbon Vault',
      tier: 'Fleet Admiral',
    ...
    {
      id: 'WHL-003',
      alias: 'üî± Captain Nemo Syndicate',
      address: '0x71F...9022',
      totalStaked: 720000,
      primaryPool: '‚öì 30-Day Sovereign Reserve',
      tier: 'Fleet Admiral',
    ...
    {
      id: 'WHL-004',
      alias: 'üåä High-Seas Voyager Fund',
      address: '0x55E...3381',
      totalStaked: 510000,
      primaryPool: 'üëë 365-Day VIP Fleet Vault',
    ...
    {
      id: 'WHL-005',
      alias: '‚öì Pacific Reserve Alliance',
      address: '0x88D...4419',
      totalStaked: 390000,
      primaryPool: 'üåä Flexible Maritime Yield',
      tier: 'Sovereign Captain',
  ...
  const [socialPosts, setSocialPosts] = useState<Array<{
  ...
  }>>([
    {
      ...
      badge: 'üèÜ 365-Day VIP Maxi',
      tier: 'Fleet Admiral',
      category: 'STRATEGY',
      content: 'Pro Tip: Lock 70% of your $OD in the 365-Day VIP Vault to hit Fleet Admiral tier early. The +5.0% APY multiplier combined with 0% swap fees pays off massively over 12 months! ‚öìüåä',
    ...
    },
    {
      ...
      badge: 'üîÑ Auto-Compound Specialist',
      tier: 'Sovereign Captain',
      category: 'YIELD',
      content: 'Just reached $5,000 total staked in the Blue Carbon Vault! Enabling daily auto-compounding boosted my effective APY from 22.5% to 25.18%. The compounding math is real! üíéüìà',
    ...
    },
    {
      ...
      badge: 'üëë Official Protocol Announcement',
      tier: 'Central Reserve',
      category: 'ANNOUNCEMENT',
      content: 'MCRB Reserve Ratio updated to 104.8%! Zurich gold vault allocations have cleared. All stakers now earn an extra +0.5% bonus seigniorage yield this week! üõ°Ô∏è‚ö°',
      timestamp: '4 hours ago',
      likes: 115,
      hasLiked: false,
      tipsReceived: 45.00
  ...
  const [whaleSocialPosts, setWhaleSocialPosts] = useState<Array<{
    ...
    {
      id: 'WPOST-01',
      whaleAlias: 'üêã Sovereign Admiral Leviathan',
    ...
    {
      id: 'WPOST-02',
      whaleAlias: '‚ö° Poseidon Maritime Capital',
    ...
    {
      id: 'WPOST-03',
      whaleAlias: 'üî± Captain Nemo Syndicate',
  ...
  const handleDepositStake = (poolId: string, amount: number, currencySymbol: string = '$OD / $XOD') => {
    ...
    setTimeout(() => {
      const poolMap: Record<string, { name: string; apr: number; days: number; icon: string }> = {
        FLEX_MARITIME: { name: 'Flexible Maritime Vault', apr: 8.5, days: 0, icon: '‚ö°' },
        '30_DAY_SOVEREIGN': { name: '30-Day Sovereign Reserve Pool', apr: 14.2, days: 30, icon: 'üõ°Ô∏è' },
        '90_DAY_CARBON': { name: '90-Day Blue Carbon Yield Vault', apr: 22.5, days: 90, icon: 'üåä' },
        '365_DAY_VIP': { name: '365-Day High-Seas VIP Vault', apr: 34.0, days: 365, icon: 'üëë' },
      };
      ...
      setStakingNotifList(prev => [
        {
          ...
          title: 'üîÑ Auto-Compound Executed',
  ...
  const handleTestNotificationPing = () => {
    ...
    const newNotif = {
      id: `STK-NT-${Math.floor(200 + Math.random() * 100)}`,
      title: '‚ö° Simulated Yield Accrual Alert',
    ...
    triggerToast(`üîî Staking Alert: +$${mockAmount} $OD yield dividend notification triggered!`);
  };
    ...
    try {
      const res = await fetch('/api/currency/ocean-dollar/transfer', {
        ...
        body: JSON.stringify({
          ...
          currencySymbol: transferCurrency === 'IOD' ? '‚öì IOD' : '‚öì OD',
      ...
      const fallbackReceipt = {
        ...
        currencySymbol: isIOD ? '‚öì IOD' : '‚öì OD',
        recipient: treasuryTransferRecipient,
        memo: treasuryTransferMemo,
      ...
      triggerToast(`Transferred ${transferAmount} ${isIOD ? '‚öì IOD' : '‚öì OD'} via SatCom Uplink!`);
    } finally {
  ...
  const [scratchCards, setScratchCards] = useState<ScratchCardData[]>([
    ...
    },
    {
      ...
      symbols: ['üëë', 'üî±', 'üíé', 'üëë', 'üëë', 'ü¶à'],
      winningSymbol: 'üëë',
      revealed: [false, false, false, false, false, false],
      isScratched: false,
      wonAmountOD: 2500
  ...
  const buyScratchCard = (card: ScratchCardData) => {
    ...
    // Randomize symbols
    const sampleSymbols = ['üî±', '‚öì', 'üíé', 'ü¶™', 'üê¨', 'üåä', 'üëë'];
    ...
    <div className="space-y-6 pb-20 text-slate-100 font-sans">
          ...
          <div className="flex items-start space-x-3.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                ...
                ‚Ä¢ ID: <code className="text-emerald-300 font-mono">{maritimePass.credentialId}</code> ‚Ä¢ AIS Geofence:{' '}
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
            ...
            <div className="space-y-1.5">
              ...
              {!jurisdictionInfo.permitted && (
                <div className="bg-rose-950/40 p-3 rounded-2xl border border-rose-500/30 text-[11px] text-rose-200/90 space-y-1 mt-2">
                  <p className="font-bold text-rose-300">‚ö†Ô∏è UNAUTHORIZED CITIZENS ACCESS RESTRICTION NOTICE:</p>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0 bg-slate-900/80 p-3 rounded-2xl border border-slate-800">
            <div className="space-y-1">
              ...
              >
                <optgroup label="‚úÖ PERMITTED ELIGIBLE COUNTRIES">
                  <option value="United Kingdom">üá¨üáß United Kingdom (UKGC License)</option>
                  <option value="Malta">üá≤üáπ Malta (MGA License Verified)</option>
                  <option value="Singapore">üá∏üá¨ Singapore (RGL Authorized)</option>
                  <option value="Isle of Man">üáÆüá≤ Isle of Man (GSC License)</option>
                  <option value="Gibraltar">üá¨üáÆ Gibraltar (GG Commissioner)</option>
                  <option value="Cura√ßao">üá®üáº Cura√ßao (eGaming License)</option>
                  <option value="Australia">üá¶üá∫ Australia (ACMA Skill Exemption)</option>
                  <option value="Canada">üá®üá¶ Canada (AGCO &amp; Provincial)</option>
                  <option value="Marshall Islands">üá≤üá≠ Marshall Islands (RMI Flag)</option>
                  <option value="Portugal">üáµüáπ Portugal (SRIJ License)</option>
                  <option value="Sweden">üá∏üá™ Sweden (Spelinspektionen)</option>
                  <option value="Germany">üá©üá™ Germany (GGL License)</option>
                  <option value="Japan">üáØüáµ Japan (Maritime Skill Gaming)</option>
                </optgroup>
                <optgroup label="‚õî UNAUTHORIZED / RESTRICTED COUNTRIES">
                  <option value="United States">üá∫üá∏ United States (State Restrictions)</option>
                  <option value="China">üá®üá≥ China (Article 303 Ban)</option>
                  <option value="North Korea">üá∞üáµ North Korea (OFAC Sanctioned)</option>
                  <option value="Iran">üáÆüá∑ Iran (Prohibited Jurisdiction)</option>
                  <option value="Syria">üá∏üáæ Syria (OFAC Sanctioned)</option>
                  <option value="Russia">üá∑üá∫ Russia (Sanctioned Jurisdiction)</option>
                  <option value="Cuba">üá®üá∫ Cuba (OFAC Sanctioned)</option>
                  <option value="Myanmar">üá≤üá≤ Myanmar (FATF Restricted)</option>
                </optgroup>
              </select>
            </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            <div className="bg-slate-900/90 p-2.5 rounded-2xl border border-slate-800 text-center space-0.5">
              ...
              <div className="text-xs font-black text-emerald-400 font-mono">$1 IOD = $1 OD = ‚Çπ83.50 INR = $1.00 USD</div>
            </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-300 text-xs sm:text-sm max-w-2xl leading-relaxed">
                Online lottery draws, instant high-seas scratch cards, live sports & regatta betting, treasure roulette, provably fair gaming, and the <strong className="text-emerald-300 font-mono">$OD (Digital Ocean Dollar)</strong> ocean money currency system ‚Äî strictly for verified seafarers, ocean employees, and cruise passengers.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-300 text-[11px]">
                  Session Active: <strong className="text-white">{sessionTimeMinutes} mins</strong> ‚Ä¢ Daily Cap: <strong className="text-emerald-400">{currentDailyWagered} / {dailyWagerLimit} $OD</strong>
                </p>
              </div>
            </div>
        ...
        <div className="bg-slate-900/90 border border-cyan-500/30 rounded-2xl p-2.5 px-4 flex items-center justify-between gap-3 text-xs font-mono overflow-hidden">
          ...
          <div className="flex-1 overflow-hidden whitespace-nowrap text-slate-200 text-xs font-mono">
            <div className="inline-block animate-pulse">
              üéâ <strong className="text-amber-300">{liveFeedItems[0]?.player}</strong> ({liveFeedItems[0]?.vessel} {liveFeedItems[0]?.flag}) <span className="text-emerald-400 font-bold">{liveFeedItems[0]?.event}</span> ‚Äî <span className="text-cyan-300 font-bold">+{liveFeedItems[0]?.amountOD} $OD</span>
            </div>
          </div>
      ...
      <div className="flex items-center space-x-2 border-b border-slate-800 pb-2 overflow-x-auto no-scrollbar">
        ...
        >
          ...
          <span>Lottery Analytics Dashboard</span>
        </button>

        <button
          onClick={() => setActiveTab('predictive-win-engine')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'predictive-win-engine' ? 'bg-cyan-500 text-slate-950 font-black shadow-lg shadow-cyan-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
          <Cpu className="w-4 h-4 text-cyan-400 animate-pulse" />
          <span>Predictive Win Engine</span>
        </button>

        <button
          onClick={() => setActiveTab('lottery-history-chart')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'lottery-history-chart' ? 'bg-amber-500 text-slate-950 font-black shadow-lg shadow-amber-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
          <History className="w-4 h-4 text-amber-400" />
          <span>Lottery History Chart</span>
        </button>

        <button
          onClick={() => setWinningAlertModalOpen(true)}
          className="px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 bg-rose-500/20 text-rose-300 hover:bg-rose-500/30 border border-rose-500/40 shadow-lg shadow-rose-500/10"
        >
          <Bell className="w-4 h-4 text-rose-400 animate-bounce" />
          <span>Winning Alert Setup</span>
        </button>

        <button
          onClick={() => setActiveTab('lottery-profit-calculator')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'lottery-profit-calculator' ? 'bg-emerald-500 text-slate-950 font-black shadow-lg shadow-emerald-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
        ...
        <button
          onClick={() => setActiveTab('winner-verification')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'winner-verification' ? 'bg-cyan-500 text-slate-950 font-black shadow-lg shadow-cyan-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
        ...
        <button
          onClick={() => setActiveTab('animate-live-draw')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'animate-live-draw' ? 'bg-amber-500 text-slate-950 font-black shadow-lg shadow-amber-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
          <Play className="w-4 h-4 text-amber-400 animate-pulse" />
          <span>Animate Live Draw</span>
        </button>

        <button
          onClick={() => setActiveTab('lottery-payout')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'lottery-payout' ? 'bg-emerald-500 text-slate-950 font-black shadow-lg shadow-emerald-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
        ...
        <button
          onClick={() => setActiveTab('draw-security-log')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'draw-security-log' ? 'bg-cyan-500 text-slate-950 font-black shadow-lg shadow-cyan-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
          <ShieldAlert className="w-4 h-4 text-cyan-400" />
          <span>Draw Security Log</span>
        </button>

        <button
          onClick={() => setActiveTab('winner-spotlight')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${activeTab === 'winner-spotlight' ? 'bg-amber-500 text-slate-950 font-black shadow-lg shadow-amber-500/20' : 'bg-slate-900 text-slate-300 hover:bg-slate-800 border border-slate-800'}`}
        >
        ...
        <button
          onClick={() => setActiveTab('lottery-winnings-bank')}
          className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-2 shrink-0 ${
        ...
        >
          ...
          <span>Winnings Banking (Withdraw/Deposit)</span>
        </button>
      ...
      {activeTab === 'lottery-hub' && (
        <div className="space-y-6">
          <LiveDrawTimerComponent
            onQuickPickTicket={() => {
              setLotterySubTab('mega-jackpot');
              handleQuickPick();
            }}
            onOpenWinningAlerts={() => setWinningAlertModalOpen(true)}
          />
          {/* SUB NAV FOR GAMES */}
                    ...
                    <div className="p-3 bg-slate-950 rounded-xl border border-emerald-500/40 flex items-center justify-between text-xs">
                      <div>
                        ...
                        <span className="text-emerald-400 font-black text-sm">
                          {simulatedMatchCount === 5 && simulatedHasCoral && 'TIER 1 GRAND PRIZE: $2,695,000 $OD üéâ'}
          ...
          {lotterySubTab === 'my-tickets' && (
            ...
            {/* LOTTERY WINNINGS BANKING PORTAL TAB */}
      {activeTab === 'lottery-winnings-bank' && (
        <LotteryWinningsBankingPortal
          oceanDollarBalance={oceanDollarBalance}
          onBalanceChange={(newBal) => setOceanDollarBalance(newBal)}
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-sans">
                  Hardware Security Module: AES-256 Quantum-Resistant SatCom Mesh ‚Ä¢ Daily Velocity Limit: {dailyVelocityLimitOD.toLocaleString()} $OD
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-1">
                  ...
                  <span className="text-[10px] text-slate-500 block">‚âà ${(oceanDollarBalance * 1.0).toFixed(2)} USD</span>
                </div>
                <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-1">
          ...
          {walletSubTab === 'BRIDGE_CONVERTER' && (
            <div className="space-y-6 font-sans">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono">
                {[
                  { currency: 'USD ($)', rate: 1.0, flag: 'üá∫üá∏' },
                  { currency: 'EUR (‚Ç¨)', rate: 0.92, flag: 'üá™üá∫' },
                  { currency: 'GBP (¬£)', rate: 0.78, flag: 'üá¨üáß' },
                  { currency: 'INR (‚Çπ)', rate: 86.5, flag: 'üáÆüá≥' },
                  { currency: 'LKR (Rs)', rate: 302.0, flag: 'üá±üá∞' },
                  { currency: 'USDT (Crypto)', rate: 1.0, flag: 'üåê' }
                ].map((cur) => (
              ...
              <div className="bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    >
                      <option value="OD">üåê Ocean Dollar ($OD / $XOD)</option>
                      <option value="IOD">üåä Indian Ocean Dollar ($IOD)</option>
                    </select>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <option value="FLEX_MARITIME">‚ö° Flexible Maritime Vault (8.5% APY - 0 Days)</option>
                      <option value="30_DAY_SOVEREIGN">üõ°Ô∏è 30-Day Sovereign Reserve Pool (14.2% APY - 30 Days)</option>
                      <option value="90_DAY_CARBON">üåä 90-Day Blue Carbon Yield Vault (22.5% APY - 90 Days)</option>
                      <option value="365_DAY_VIP">üëë 365-Day High-Seas VIP Vault (34.0% APY - 365 Days)</option>
                    </select>
                  </div>
                              ...
                              <td className="p-4 font-sans">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-slate-400 text-[10px] font-mono">{pos.id} ‚Ä¢ Started {pos.startDate}</span>
                                  </div>
                                </div>
                              </td>
                ...
                <div className="lg:col-span-6 space-y-6 font-mono text-xs">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      >
                        <option value="DAILY">‚ö° Daily Compounding (n=365)</option>
                        <option value="WEEKLY">üìÖ Weekly Compounding (n=52)</option>
                        <option value="MONTHLY">üóìÔ∏è Monthly Compounding (n=12)</option>
                        <option value="YEARLY">‚è≥ Simple Annual (n=1)</option>
                      </select>
                    </div>
            ...
            <div className="bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-8 font-sans">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs">
                ...
                <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 space-y-3">
                  ...
                  >
                    <option value="DAILY">‚ö° Daily Automated Cycle (00:00 UTC)</option>
                    <option value="WEEKLY">üìÖ Weekly Reinvestment (Sundays)</option>
                    <option value="THRESHOLD">üéØ Threshold Trigger ($10+ Yield)</option>
                  </select>
                ...
                <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 space-y-3">
                  ...
                  >
                    <option value="30_DAY_SOVEREIGN">üõ°Ô∏è 30-Day Sovereign Reserve (14.2% APY)</option>
                    <option value="90_DAY_CARBON">üåä 90-Day Blue Carbon Vault (22.5% APY)</option>
                    <option value="365_DAY_VIP">üëë 365-Day High-Seas VIP Vault (34.0% APY)</option>
                  </select>
                  <p className="text-slate-500 text-[10px] font-sans">
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div className="p-2.5 rounded-xl bg-slate-950 border border-slate-800 text-lg shrink-0">
                        {notif.type === 'YIELD_PAYOUT' ? '‚ö°' : notif.type === 'AUTO_COMPOUND' ? 'üîÑ' : notif.type === 'BONUS_BOOST' ? 'üëë' : 'üîì'}
                      </div>
                      <div className="space-y-1">
                        <div className="flex items-center space-x-2">
                          ...
                          <tr key={item.id} className="hover:bg-slate-800/40 transition-all">
                            <td className="p-4">
                              <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold border ${
                                ...
                                {item.action === 'STAKE_DEPOSIT' ? 'üì• Deposit Stake' :
                                 item.action === 'YIELD_CLAIM' ? '‚ö° Yield Claimed' :
                                 item.action === 'AUTO_COMPOUND' ? 'üîÑ Auto Restaked' :
                                 item.action === 'GOVERNANCE_VOTE' ? 'üó≥Ô∏è Cast Vote' : 'üîì Lock Matured'}
                              </span>
                            </td>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full space-y-6 shadow-2xl font-sans">
                ...
                <div className="space-y-4 font-mono text-xs">
                  ...
                  <div className="space-y-1.5 font-sans">
                    ...
                    >
                      <option value="APY_THRESHOLD">‚ö° APY % Exceeds Target Rate</option>
                      <option value="LOCKUP_MATURITY">üîì Lockup Maturity Countdown (Days)</option>
                      <option value="UNCLAIMED_YIELD">üíµ Unclaimed Yield Reaches Threshold ($OD)</option>
                      <option value="RESERVE_PARITY">üõ°Ô∏è Maritime Reserve Ratio Parity Shift</option>
                    </select>
                  </div>
                          ...
                          return (
                            <tr key={w.id} className="hover:bg-slate-800/40 transition-all">
                              <td className="p-4">
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-slate-500 text-[10px]">{w.address} ‚Ä¢ {w.nodeRegion}</span>
                                  </div>
                                </div>
                              </td>
                              <td className="p-4">
                              ...
                              <td className="p-4 text-center">
                                ...
                                >
                                  {isFollowed ? '‚úì Tracking' : '+ Follow Alerts'}
                                </button>
                              </td>
                            </tr>
                          );
            ...
            <div className="bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-6 font-sans">
              ...
              <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 space-y-4">
                <div className="flex items-center justify-between font-mono text-xs">
                  ...
                  >
                    <option value="STRATEGY">üí° YIELD STRATEGY</option>
                    <option value="YIELD">üìà YIELD MILESTONE</option>
                    <option value="QUESTION">‚ùì STAKING QUESTION</option>
                  </select>
                </div>
            ...
            <div className="bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-8 font-sans">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 font-mono text-xs">
                ...
                <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 space-y-2">
                  ...
                  >
                    <option value="30_DAY">‚öì 30-Day Sovereign Reserve (18.5% APY)</option>
                    <option value="90_DAY">üíé 90-Day Blue Carbon Vault (22.5% APY)</option>
                    <option value="365_DAY">üëë 365-Day VIP Fleet Vault (34.0% APY)</option>
                  </select>
                </div>
                  ...
                  <div className="space-y-6 font-mono text-xs">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="bg-slate-900 p-5 rounded-3xl border border-emerald-500/30 space-y-2">
                        ...
                        <span className="text-slate-300 font-bold block text-sm">‚âà ${usdValue.toLocaleString('en-US', { maximumFractionDigits: 0 })} USD</span>
                      </div>
                    ...
                    <div className="bg-slate-900 p-6 rounded-3xl border border-slate-800 space-y-3 font-sans">
                      ...
                      <div className="flex justify-between items-center text-[10px] font-mono text-slate-400">
                        ...
                        <span className="text-amber-400 font-bold">Target: Fleet Admiral ($25,000 $OD) ‚Äî {totalTokens >= 25000 ? '‚úÖ REACHED!' : `Need ${(25000 - totalTokens).toFixed(0)} $OD more`}</span>
                      </div>
                    </div>
                  </div>
                );
                    ...
                    <div key={post.id} className="bg-slate-900 p-6 rounded-3xl border border-cyan-500/30 space-y-4 font-sans hover:border-cyan-400/60 transition-all shadow-xl group">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-3">
                        <div className="flex items-center space-x-2.5">
                          ...
                          <div>
                            ...
                            <span className="text-slate-500 text-[10px] font-mono">{post.whaleAddress} ‚Ä¢ {post.timestamp}</span>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-slate-800/60 font-mono text-xs">
                        <div className="flex items-center space-x-3">
                          ...
                          >
                            <span>üöÄ Upvote ({post.upvotes})</span>
                          </button>
                          ...
                          >
                            <span>{post.hasCopied ? '‚úì Formula Copied' : 'üéØ Copy Whale Strategy'}</span>
                  ...
                  <div className="bg-slate-900 border border-emerald-500/40 rounded-3xl p-6 sm:p-8 max-w-lg w-full space-y-6 font-sans shadow-2xl">
                    <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                      <div>
                        ...
                        <span className="text-slate-400 text-xs font-mono">{selectedStockForOrder.ticker} ‚Ä¢ {selectedStockForOrder.sovereignRating}</span>
                      </div>
                      <button
                ...
                <div className="space-y-3 font-mono text-xs">
                  {[
                    ...
                    },
                    {
                      ...
                      a: '$OD is the display name for Ocean Dollar, officially represented on international trading terminals by ISO 4217 currency code XOD (Code 998). $IOD (XIOD / 999) is the Indian Ocean Dollar regional variant. Both trade at 1:1 fixed parity with USD and ‚Çπ83.50 INR.'
                    },
                    {
                      id: 'faq-4',
                      cat: 'Yields',
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <span className="text-slate-400 font-bold shrink-0">{isExpanded ? '‚àí' : '+'}</span>
                          </button>
                          ...
                          {isExpanded && (
                            <div className="p-4 pt-0 font-sans text-xs text-slate-300 border-t border-slate-800/60 mt-2 space-y-2 leading-relaxed">
                              ...
                              <div className="flex items-center space-x-2 text-[10px] text-cyan-400 font-mono pt-1">
                                ...
                                <span>Verified ODMA Directive ‚Ä¢ SatCom Hash #2026-XOD-01</span>
                              </div>
                            </div>
                          )}
                        </div>
            ...
            <div className="bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-8 font-sans">
              ...
              <div className="bg-gradient-to-r from-slate-900 via-fuchsia-950/40 to-slate-900 p-6 rounded-3xl border border-fuchsia-500/30 space-y-4 font-mono text-xs shadow-xl">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  >
                    <Coins className="w-4 h-4" />
                    <span>{isCopiedRefLink ? '‚úì Copied Link!' : 'Copy Referral Link'}</span>
                  </button>
                </div>
              </div>
              ...
              <div className="bg-slate-900 p-6 rounded-3xl border border-slate-800 space-y-4 font-mono text-xs">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-950 p-4 rounded-2xl border border-purple-500/30">
                  ...
                  >
                    ...
                    <span>{hasClaimedMonthlyTierPerk ? '‚úì Monthly Perk Claimed' : 'Claim Monthly Perk'}</span>
                  </button>
                </div>
              </div>
              ...
              <div className="bg-slate-900 p-6 rounded-3xl border border-slate-800 space-y-4 font-mono text-xs overflow-x-auto">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-800/60 text-xs">
                    <tr>
                      <td className="p-3 text-white font-bold font-sans">üåä Flexible Maritime Yield</td>
                    ...
                    <tr>
                      <td className="p-3 text-white font-bold font-sans">‚öì 30-Day Sovereign Vault</td>
                    ...
                    <tr>
                      <td className="p-3 text-white font-bold font-sans">üíé 90-Day Blue Carbon Vault</td>
                    ...
                    <tr>
                      <td className="p-3 text-white font-bold font-sans">üëë 365-Day VIP Fleet Vault</td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-400 font-mono">
                  {GLOBAL_LEADERBOARD_DATA[1].role} ‚Ä¢ <span className="text-slate-300">{GLOBAL_LEADERBOARD_DATA[1].vesselName}</span>
                </p>
              </div>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-300 font-mono">
                  {GLOBAL_LEADERBOARD_DATA[0].role} ‚Ä¢ <span className="text-amber-200">{GLOBAL_LEADERBOARD_DATA[0].vesselName}</span>
                </p>
              </div>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-400 font-mono">
                  {GLOBAL_LEADERBOARD_DATA[2].role} ‚Ä¢ <span className="text-slate-300">{GLOBAL_LEADERBOARD_DATA[2].vesselName}</span>
                </p>
              </div>
            ...
            <div className="flex items-center space-x-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-0.5">
                  Earnings: <strong className="text-emerald-400">{oceanDollarBalance.toFixed(2)} $OD</strong> ‚Ä¢ Win Streak:{' '}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-300 font-mono mt-0.5">
                    CDC ID: <strong className="text-cyan-300">{maritimePass.credentialId}</strong> ‚Ä¢ Vessel: <strong className="text-white">{maritimePass.vesselOrCompany}</strong>
                  </p>
                </div>
              </div>
              ...
              <button
                onClick={() => {
                  ...
                  generateAndDownloadPdf({
                    ...
                    issueTimestamp: new Date().toISOString(),
                    qrPayload: maritimePass.verificationHasxú‘YmO„H˛>ø¢çÜ∞¬IH`nñN∆1‡ùºX±ÑF+∂cw/∑e;$‚ø_µù8∂”Œ†Ÿ˚p€$¥€U’’UœS’L?¿Œx;˙mgˆÌmg a$ä˙dF/FÖŒhHò´ú5õ0Â/4<œMû‚dLó±1SÂ◊≥&åπ+#Fúgñ )+•U?Éêœ}ó∫ í•/,#àC‚G^Ïq_!å¡ò—%x1ùEäC˝òÜƒ° RiA4%._(lÇﬂBœVö%≥Øv∂q—·üq‚Ê7¥@ã¶¯S4˙ í˜QΩ•/∆ıQçÜ±7ˆ|	jfÁÊË¢ë,)Ωy—Õ„òóÊ/Æ˜rı°8áSy„&°ÁÇ¯•8úEb€≥ÛÌüß0!Å“N<„>ﬂ8Ú`«Çí\<∞ıVõÕ∆ó&)πÛÒ–EoßÎï_öÕ±kó‰%'|?iÀ?Ú.a1b‹y>∏Í®F˜˚Æ3T‘.h™)˜õD|Kúπ©\‘\}<k7Qœ«A–!´™”H¸˛ˇÎ†û~´¬Ô™ˆ’ÿ†jönY?Î2°}maŸù7ô*CŒ⁄}ÔM‘˝á:hà≤m,s0¥-∏÷Ìüvê≥"~ÍüYÇìgÅ!‚⁄?’=Éæ¢›©F‘˚éa√ùj›˝¨{RŸmÅÈ·‹Opn≠‰uFBDÍ5Ò›:í@äÉ›w$ö÷#Ê9¥÷<Üì÷—[Ω^∑+w¶vaÚµÒX∂nö˙Ã·‡và	ø4Ú¥ıS8ZÚ˛Î˜íµØ≈48áìcàΩò—s8<©É·"5yÒ
:‹ôœ˚·1∏4r©÷—àåﬁ k·‹ã(ùCx;Æ‹⁄
n’·Ü8a–ı^®O£h+ˆ⁄„3áû¯ñC¸=b€[±Ì:|CYîÅr>ﬁ T,<^∆êo°G|oL£xè–”≠–”:tÈ lØ3á∞ú¬UÛIHÇ)∆c+∞ºâO]]ê¸G}FÇZ-:ÇÀ+®ï„$Âœù}¶´À◊®.,⁄-Z∏Øa>_æ÷ôçøÆó÷“7éˆ’9Øb@‰äî÷6iìƒ`tóÀïèØí
Î9’	óóóêÍï,¯+´F´πÅáù“j1áîU@áRâÁkup±±aè‚m±V“),9m…·†J•TVoyL9ì	y˚≥|&»*•ˆnë¯◊<¬™l•åhº†‘œ™Àmôî°úp7e∆U‡oUÿâπ∞ÒevÃü>¡Ö6•Œ≥ÊÖ£≠b•)"jö¸ﬁ©^∞ﬁ‹çG)’¸'¿,Vöı≥±)ëó{í◊©GÖD©Üc–}[Ô€`™}Ω˚#Dñ nº‰≥/P>ØÀˇïrVÜÍ|ñùàCÿAêí˙ç§Sòë•≤@NñqÔ¥Ω„ÂAœu4πÑ‹”Æ»„Ï∆c‘∆˜ãA"B‰,Wù¨££2Pìçüú#hßÑú‹¢Ÿ©‰˛∆¥]j?ˆy™båå˘À^íg[π¶Xóñﬁ’5zÍ–∞çû⁄PÔ`ÿÿè¶~~—HîH’ÔÁ˘ì"œ∑ûóoD¬˜Ÿ‹îÕüÆÉØ»mâ=8eQ2√LºÊ¸YP|GìfIä•´=µˇd™VRΩÊÑâÛÛ)∆XHaÏH+Ö≤I√{√“—*uÿ1˙∑â‘úƒuÕ!*4ÍOP¶¯V&ﬁÕX∞+%‡ÃﬂDº	!ªuœïÎCJÀ≤ˆ*†5Ò*êàøí–ÛfîhZRXÇ0Ωwpu∂ãÃ†PÑQ{Vo84I÷"soÚ7árÊ‹åÉ6˜3ËÈˆ˙%øÍﬂUÏ,∆.¡nÜ<'ƒ¿ÛL™ÍM9kl∆ëÙ´àMr%íÃó…#›pk„[Íºæ.\
}ÿÁ]FIa6è÷´ùF`mCä¶„Û“˝—Ï/E¿ÜŸR!ÛòW∑t˜…ì†K∑öíyßÇEê–Éw¸~r")2º>∏ÍÑdÇ)ËÇÚ ‹ùDÿf Gö˘Bê ÍçíkØc¯›º=≥{TaG≈yÔîRTelÜ ¬µCáÒ”Ò˙‰∏ŒS⁄ôR˜©’l}~
È<9≈z‡é%wüÈ¿ﬁjÇpis≈µ√åNC™§oc®}Ç@†™mÿxn“˚˛´J®‰RUåbAîGêÏb5õl7ãW•™)[w÷î¿_vÒZ∏v-`b˘˛TyLiÄµM˙N^óûx*T&ye(Twr-)∫¸/Ø´?Øµ∏Òwn´wù\]ÿaãÓP±òCR„µ™;—sºÑ‹zìi©úLn∑Â◊ŸG$IVY ˝Æøâ∂¿ƒJŒ–l„õFÙ˛≠—◊¡VØsÕ¡+qbÔÖ⁄dîêÌaR◊K¶îÖÁ+X∏`UtX¨È/∫<FØÃlÌÉÁÎ… o]‰lÂ˛ı|ec–√«üœ¢cF¯bë%Åå≠ÅCâﬂ·åëö0$µıí¨ÓëxäÖ“R\mâIP÷¢Jy_Ñ’Ä≠©`1/ s:S"ƒö;ç¢Òú±U	?r®—ê{∏;∞m}¯wÜeSªSáˆ<ÃRÁ)S/ä9~¢aúxx„◊ªÙâ&á&Õ©D+j_Ç⁄Wªè∂°YÔTL|¬V±ÁD•xÑ>’Õ≥}z˚€∏14’6}∞t€∆‚˜Ω }gWïE˙π'çcœüÏµ¬n4µ´›wUtˇ;-B>ˆ«	sÊà:<,Xa&OµÏ°ÃÒèìçÛøÈ√≠/ˆ∞H<¨‰/kS’H¯ã‘˝ﬂrœdö’æ—SmΩ]ë‘â˚uﬂõ	de"°]‘ìjT”iW‹n
Ìü‹,[Âlıqpˇﬁ»»äœã!m&SïŒ¥tÌ€œG‘w˚%bJDù9∂€+ÖÒ…÷á÷z∂À'2MÎ√∆œÓ∑w?⁄Õ˙∏¢Ä«L‡z™'='k3)”s£Zv¢”‘ÆéàÄIroBo–¡¶z´1ÜaÆ2∆ÚÛ†«]¬2–Ò¢A@˝À◊EnY≤BLo±I3èhéüd/‘∆ÑE4£í5¢eÙÅ»˜ˆ€áˇ  ˇˇ /]Rf